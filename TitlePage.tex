...
{\red{TODO:
    ...
    Chiral symmetry section - say why $B_s\to D_s$ and $B\to D$ are approx. equal.

    acknowledge NRQCD has no continuum limit in lattice NRQCD section...

    Luke's theorem bit needs to be tighter, specifically why you get specific $h_{A_1},h_+$ expressions.
