...
\end{align}
irreps of which we denote with $(x,y,z)$, where $x,y$ label the $SU(3)_C$ and $SU(2)_L$ irreps and $z$ is the charge under $U(1)_Y$. The subscript $C$ stands for color (corresponding to the {\it{strong nuclear force}}), $L$ denotes the {\it{weak nuclear force}}, and $Y$ denotes {\it{hypercharge}}.
